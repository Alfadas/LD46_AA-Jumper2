...
public class TurretTargetHelper : MonoBehaviour
{
    ...
    public Vector3 CalcTargetLeadPoint()
    {
        ...
        float t = FirstOrderInterceptTime(turret.WeaponController.MuzzleSpeed, targetRelativePosition, turret.Target.Velocity);
        float timeGravity = FirstOrderInterceptTime(turret.WeaponController.MuzzleSpeed, targetRelativePosition, gravity);
